...
def classify_custom_transaction():
    ...
    fresh = float(input(colored("\tGasto anual em produtos frescos (em u.m.): ", 'blue')))
    milk = float(input(colored("\tGasto anual em produtos de laticínios (em u.m.): ", 'blue')))
    grocery = float(input(colored("\tGasto anual em produtos de mercearia (em u.m.): ", 'blue')))
    frozen = float(input(colored("\tGasto anual em produtos congelados (em u.m.): ", 'blue')))
    detergents_paper = float(input(colored("\tGasto anual em detergentes e papel (em u.m.): ", 'blue')))
    delicatessen = float(input(colored("\tGasto anual em produtos de delicatessen (em u.m.): ", 'blue')))
